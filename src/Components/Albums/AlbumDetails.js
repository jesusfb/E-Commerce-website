...
const AlbumDetails = (props) => {
  ...
  return (
    <Modal>
      <div className="text-center overflow-scroll" style={{ maxHeight: "300px" }}>
        <img src={props.img} alt={props.name} className="w-64 mx-auto mb-4 border-1 border-red-400 shadow-lg rounded" />
