...
const LoginPage = () => {
  ...
  const submitHandler = async (event) => {
    ...
    if (isLogin) {
      URL =
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyB_K-9Van1Ahl-3TdJXL88hBDtiNMebr5I";
    } else {
      URL =
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyB_K-9Van1Ahl-3TdJXL88hBDtiNMebr5I";
    }
    try {
  ...
  return (
    ...
    <div className="bg-gradient-to-r from-gray-800 via-gray-800 to-gray-300 flex items-center justify-center min-h-screen">
      ...
      <h1 className="text-center text-sm font-semibold"><span className="text-red-700">😊WELCOME</span> TO <span className="text-pink-600">BOOKMYSHOW😊</span></h1>
