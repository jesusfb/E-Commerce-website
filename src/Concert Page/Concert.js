    ...
    <Fragment>
      ...
      <div className="mt-1">
        <h1 className="p-5 md:p-10 text-4xl md:text-8xl text-center bg-red-200">
          ...
          <button className="text-xl border-1 rounded border-sky-600 text-center p-2 px-3 hover:bg-red-300 hover:font-semibold">Get Our <span className="text-red-600">Latest</span> Album</button>
          <FaPlayCircle size={40} className="m-auto mt-2 cursor-pointer rounded-full" />
          </div>
        </h1> 
      </div>
      <section className="mt-0 mx-auto text-xl px-4 md:w-3/4 lg:w-3/4">
        ...
        <div>
          ...
          <ConcertDetails date="AUG 24" city="Kolkata" location="Satyajit Ray Auditorium"/>
          <ConcertDetails date="SEP 27" city="Pune" location="Royal Orchid Central"/>
          <ConcertDetails date="SEP 17" city="Bangalore" location="SMVIT College"/>
