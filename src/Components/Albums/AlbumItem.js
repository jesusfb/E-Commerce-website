  ...
  const productsArr = [
    {
      title: "ALBUM 1",
      Name: "Tera Zikr",
      Lyrics:"Abhi abhi to mile the Phir juda ho gaye Kya thi meri khataa Tum sazaa ho gaye Mujhe khone ke baad ik din Tum mujhe yaad karoge Phir dekhna milne ki mujhse Tum fariyad karoge Mujhe khone ke baad ik din Tum mujhe yaad karoge Phir dekhna milne ki mujhse Tum fariyad karoge.....",
      Rating:4.5,
    ...
    },
    {
      title: "ALBUM 2",
      Name: "Asal Mein",
      Lyrics:"Kyun Khuda ne di laqeerein Jisme zaahir naam nahi tera Likh raha hoon dard saare Yun toh shayar naam nahi mera Itna bhi kya bewafa koi hota hai Yeh soch kar raat bhar dil ye rota hai Asal mein, tum nahi ho mereTum nahi ho mere .....",
      Rating:4.6,
      Singer:"Darshan Raval",
      price: 150,
      imageUrl: IMG4,
    },
    {
      title: "ALBUM 3",
      Name: "How Many",
      Lyrics:"Remember when I’d throw stones at your window I could tell you’re the one you’re the end goal We were set, we were what everyone wants No one thinks when you’re deep,How many times can we break our hearts?How many times can we fall apart? .....",
      Rating:3.5,
      Singer:"Arman Malik",
      price: 170,
      imageUrl: IMG5,
    },
    {
      ...
      Lyrics:"HUM NAHI SUDHREGE,DIL MEIN HO TUM,PEHLA PYAAR,BOL DO NA ZARA,KAUN TUJHE ANd MANY MORE ....",
      Rating:4.0,
      Singer:"Arman Malik",
      price: 400,
      imageUrl: IMG6,
    },
    {
      ...
      Lyrics:"KESARIYA,AGAR TUM SATH HO,O BEDARDEYA,PHIR AUR KYA CHAHIYE,TUJHE KITNA CHAHNE LAGE ANd MANY MORE ....",
      Rating:4.5,
      Singer:"Arijit Singh",
      price: 800,
      imageUrl: IMG1,
    ...
    },
    {
      title: "ALBUM 7",
      Name: "Teri Hogaiyaan",
      Lyrics:"Kaisa pyaar tu jataaye Kaise paas mere aaye Kaisa pyaar tu jataaye Kaise paas mere aaye Main nibhaaun tere dil ki ye choriyaan Main teri hogaiyaan, haan.. Main teri hogaiyaan... Main teri hogaiyaan... Hmm... haan... Teri laag aisi laagi Rain saari saari jaagi Teri laag kaisi maahiya .... ",
      Rating:5.0,
    ...
    },
    {
      title: "ALBUM 8",
      Name: "Yeh Kya Hua",
      Lyrics:"Yeh kya hua Kuch pata na chala Kyun haadsa ban gaya silsila Tukdo mein tum the Tukdo mein main bhi Tukde bane toh hum bane Yeh dil zindagi se Khafa ho chala tha Jisey phir se jeene ke bahaane tum bane Tanha safar ke mushkil dagar mein Tum humsafar jo mil gaye Hai zakhm saare sil gaye ..... ",
      Rating:4.9,
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex flex-col sm:flex-row gap-2">
                        ...
                        <Button
                          variant="secondary"
                          onClick={() => {
                            handleViewDetails(item.Name,item.imageUrl,item.Lyrics,item.Rating,item.Singer);
                          }}
                          className="mb-2 sm:mb-0"
                        >
                          View Details
